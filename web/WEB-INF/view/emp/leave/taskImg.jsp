...
<img style="position: absolute;top: 0px;left: 0px;" src="<%=request.getContextPath()%>/zeroLeave/selectProgressDefineimg?did=${pd.deploymentId}&imageName=${pd.diagramResourceName}">
<!-- 2.根据当前活动的坐标，动态绘制DIV -->
